...
export default function SpendingsInput() {
  ...
  useEffect(() => {
    ...
    const currentTrip = userTrips?.find((t: UserTrip) => t.id === tripId);
    if (currentTrip) {
      setTotalBudget((currentTrip as any).totalBudget || 0);
    }
    ...
    <View style={styles.mainWrapper}>
      ...
      {loading && (
        <View style={styles.animationOverlay}>
          <LottieView
            source={require("@/src/assets/animations/wallet.json")}
            autoPlay
            loop
...
const styles = StyleSheet.create({
  ...
  setupHeader: { fontSize: width * 0.05, fontFamily: "outfitBold", marginBottom: 20 },
  input: {
    borderWidth: 1,
    borderColor: "#ccc",
    padding: 12,
  ...
  statLabel: { color: "rgba(255,255,255,0.6)", fontSize: 10, fontFamily: "outfit" },
  statValue: { color: "#FFF", fontSize: 15, fontFamily: "outfitBold", marginTop: 2 },
  statDivider: { width: 1, height: 25, backgroundColor: "rgba(255, 253, 253, 0.2)" },
  ...
  historyHeader: { fontSize: width * 0.05, fontFamily: "outfitBold", color: Colors.BLACK },
  sortButton: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: Colors.WHITE,
  ...
  setTotalButton: { padding: 15, width: "100%" },
