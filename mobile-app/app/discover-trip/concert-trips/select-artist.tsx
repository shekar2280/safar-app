...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: width * 0.085, fontFamily: "outfitBold" },
  headerAccent: {
    height: 4,
    width: 40,
  ...
  cardContainer: { flex: 1, margin: 8, height: height * 0.2 },
  card: {
    flex: 1,
    borderRadius: 20,
    overflow: "hidden",
  ...
  continueText: { color: Colors.WHITE, fontFamily: "outfitMedium" },
});
