...
import { TrendingTripsCardProps } from "@/src/types/interfaces";

const { width, height } = Dimensions.get("window");

export default function TrendingTripsCard({ option, selectedOption, cardHeight }: TrendingTripsCardProps) {
