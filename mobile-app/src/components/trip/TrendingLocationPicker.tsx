...
import { TrendingLocationData, TrendingLocationPickerProps, NominatimResult } from "@/src/types/interfaces";

export default function TrendingLocationPicker({
  title,
  onLocationChange,
  placeholder = "Search city...",
}: TrendingLocationPickerProps) {
  ...
  const formatLocationData = (data: NominatimResult, lat: number | string, lon: number | string): TrendingLocationData => {
        ...
        <View style={styles.manualContainer}>
          ...
          <View style={styles.autocompleteWrapper}>
            <AutocompleteInput
              ...
              autoCorrect={false}
              onChangeText={(text: string) => setState((s) => ({ ...s, query: text }))}
