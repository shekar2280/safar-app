...
const styles = StyleSheet.create({
  ...
  iconContainer: { width: 44, height: 44, borderRadius: 14, backgroundColor: "#FDF9F0", justifyContent: "center", alignItems: "center", marginRight: 16 },
  label: { fontFamily: "outfitMedium", fontSize: 10, color: Colors.MUTED_TEXT, letterSpacing: 1, marginBottom: 2, textTransform: "uppercase" },
  value: { fontFamily: "outfitBold", fontSize: 15, color: Colors.TEXT, lineHeight: 20 },
  bookButton: { margin: 24, marginTop: 0, backgroundColor: Colors.PRIMARY, paddingVertical: 16, borderRadius: 16, flexDirection: "row", justifyContent: "center", alignItems: "center", shadowColor: Colors.PRIMARY, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.2, shadowRadius: 12 },
  bookButtonText: { color: Colors.WHITE, fontFamily: "outfitBold", fontSize: 16 },
});
