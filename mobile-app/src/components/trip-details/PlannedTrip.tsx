    ...
    return (
      <View style={styles.wrapper}>
        ...
        <TouchableOpacity activeOpacity={0.95} onPress={onActivate} style={styles.premiumLockCard}>
          <LinearGradient colors={[Colors.PRIMARY, "#2C2C2C"]} style={styles.gradientBg}>
...
const styles = StyleSheet.create({
  ...
  gradientBg: { padding: 35, alignItems: "center", justifyContent: "center" },
  lockIconContainer: {
  ...
  lockTitle: { fontFamily: "playfairBold", fontSize: 24, color: Colors.WHITE, textAlign: "center", marginBottom: 12 },
  lockSubtitle: {
    fontFamily: "outfit", fontSize: 14, color: "rgba(255,255,255,0.6)",
    textAlign: "center", lineHeight: 22, marginBottom: 30, paddingHorizontal: 10,
  },
  unlockButton: {
    backgroundColor: Colors.SECONDARY,
  ...
  unlockButtonText: { fontFamily: "outfitBold", fontSize: 16, color: Colors.BLACK },
  successCard: {
    borderRadius: 24, overflow: "hidden", marginBottom: 24,
    elevation: 4,
    shadowColor: Colors.SECONDARY,
    shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.15, shadowRadius: 10,
  },
